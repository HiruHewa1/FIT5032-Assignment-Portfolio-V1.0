...
namespace FIT5032_Assignment_Portfolio_V1._0.Controllers
{
    public class ReportsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ReportId,Description,Date")] Report report)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ReportId,Description,Date")] Report report)
        {
            if (ModelState.IsValid)
            {
