...
namespace FIT5032_Assignment_Portfolio_V1._0.Controllers
{
    ...
    public class ImagesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ImageId,UltrasoundImage")] Image image, HttpPostedFileBase
postedFile)
        {
            ModelState.Clear();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ImageId,UltrasoundImage")] Image image)
        {
            if (ModelState.IsValid)
            {
