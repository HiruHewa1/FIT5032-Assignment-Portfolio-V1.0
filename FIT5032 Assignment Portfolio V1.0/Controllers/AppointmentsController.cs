...
namespace FIT5032_Assignment_Portfolio_V1._0.Controllers
{
    public class AppointmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AppointmentId,AppointmentDate")] Appointment appointment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AppointmentId,AppointmentDate")] Appointment appointment)
        {
            if (ModelState.IsValid)
            {
